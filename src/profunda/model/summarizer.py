...
from profunda.model.handler import Handler
from profunda.model.pandas import (
...
from profunda.model.summary_algorithms import (  # Check what is this method used for
    describe_file_1d,
    describe_image_1d,
    describe_path_1d,
...
class ProfilingSummarizer(BaseSummarizer):
    ...
    def _create_summary_map(self) -> Dict[str, List[Callable]]:
        ...
        if self.use_spark:
            from profunda.model.spark import (
            ...
            from profunda.model.ibis import (
