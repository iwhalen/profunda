...
class MissingDataBackend:
    ...
    def __init__(self, df: Sized):
        ...
        if isinstance(df, pd.DataFrame):
            self.backend_module = "profunda.model.pandas.missing_pandas"
        elif isinstance(df, sparkDataFrame):
            self.backend_module = "profunda.model.spark.missing_spark"
        elif isinstance(df, ibisDataFrame):
            self.backend_module = "profunda.model.ibis.missing_ibis"
        else:
